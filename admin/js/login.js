...
*******************************/
// GLOBAL PARAMS
var file		=	'login.php?form=1';
var placeholder		=	'#wrapper';
var waitholder		=	'#err';
var waitnote		=	'<img alt="" src="js/wait.gif" /><br />Veuillez patienter ...';
	...
	{ 
		...
		switch(formData[i].name)
		{
			case 'nameuser':
				...
				{
					$(waitholder).html('Nom d\'utilisateur requis').slideDown('slow');
					return false;
				}
				break;
			case 'passuser':
				...
				if(len<4||len>50)
				{
					$(waitholder).html('Mot de passe requis').slideDown('slow');
					return false;
				}
				break;															
		}
